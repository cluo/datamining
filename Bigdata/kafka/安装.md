...
3. 运行
```
    /home/hunterhug/kafka-0.10.0.0-src/bin/kafka-server-start.sh  /home/hunterhug/kafka-0.10.0.0-src/config/server.properties
...
```
    ...
    advertised.listeners=PLAINTEXT://192.168.11.73:9092
